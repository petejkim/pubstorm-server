...
func (f *FileTransfer) Upload(region, bucket, key string, body io.Reader, contentType, acl string) (err error) {
	var content []byte
	...
	f.UploadCalls.Add(List{region, bucket, key, body, contentType, acl}, List{err}, Map{
